...
_0x3:
	.DB  0x17,0x0,0x3B
_0x5:
	.DB  LOW(_0x4),HIGH(_0x4),LOW(_0x4+3),HIGH(_0x4+3),LOW(_0x4+6),HIGH(_0x4+6),LOW(_0x4+9),HIGH(_0x4+9)
_0x0:
	.DB  0x32,0x33,0x0,0x35,0x39,0x0,0x30,0x30
	.DB  0x0,0x63,0x6C,0x6F,0x63,0x6B,0x0,0x3A
	.DB  0x30,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
...
_timer1_compa_isr:
	...
	ST   -Y,R30
; 0000 0024     numbers[3]++;
	__POINTW2MN _numbers,6
	CALL SUBOPT_0x0
; 0000 0025     if (numbers[3] == 10) {
	__GETW1MN _numbers,6
	CPI  R30,LOW(0xA)
	LDI  R26,HIGH(0xA)
	CPC  R31,R26
	BRNE _0x6
; 0000 0026         numbers[3] = 0;
	__POINTW1MN _numbers,6
	CALL SUBOPT_0x1
; 0000 0027         numbers[2]++;
	__POINTW2MN _numbers,4
	CALL SUBOPT_0x0
; 0000 0028     }
; 0000 0029     if (numbers[2] == 60) {
_0x6:
	__GETW1MN _numbers,4
	CPI  R30,LOW(0x3C)
	LDI  R26,HIGH(0x3C)
	CPC  R31,R26
	BRNE _0x7
...
; 0000 00BA             itoa(numbers[0], string_numbers[0]);
	...
	ST   -Y,R31
	ST   -Y,R30
	LDS  R26,_string_numbers
	LDS  R27,_string_numbers+1
	CALL _itoa
; 0000 00BB             itoa(numbers[1], string_numbers[1]);
	__GETW1MN _numbers,2
	ST   -Y,R31
	ST   -Y,R30
	__GETW2MN _string_numbers,2
	CALL _itoa
; 0000 00BC             itoa(numbers[2], string_numbers[2]);
	__GETW1MN _numbers,4
	ST   -Y,R31
	ST   -Y,R30
	__GETW2MN _string_numbers,4
	CALL _itoa
; 0000 00BD             itoa(numbers[3], string_numbers[3]);
	__GETW1MN _numbers,6
	ST   -Y,R31
	ST   -Y,R30
	__GETW2MN _string_numbers,6
	CALL _itoa
; 0000 00BE 
